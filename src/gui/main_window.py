...
"")
        ...
        self.information_button.setStyleSheet("background: transparent; color: #fff; text-align: left;")
        self.information_button.setObjectName("information_button")
        self.source_code_link = QtWidgets.QPushButton(self.centralwidget)
        self.source_code_link.setGeometry(QtCore.QRect(180, 810, 181, 31))
        font = QtGui.QFont()
        font.setFamily("Fregat")
        font.setPointSize(13)
        self.source_code_link.setFont(font)
        self.source_code_link.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.source_code_link.setStyleSheet("background: transparent; color: #fff; text-align: left;")
        self.source_code_link.setObjectName("source_code_link")
        self.select_file = QtWidgets.QPushButton(self.centralwidget)
        self.select_file.setGeometry(QtCore.QRect(360, 810, 311, 31))
        font = QtGui.QFont()
        font.setFamily("Fregat")
        font.setPointSize(13)
        self.select_file.setFont(font)
        self.select_file.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.select_file.setStyleSheet("background: transparent; color: #fff; text-align: left;")
    ...
    def retranslateUi(self, SentimentAnalysis):
        ...
        self.select_file.setText(_translate("SentimentAnalysis", "Выбрать файл для анализа"))
